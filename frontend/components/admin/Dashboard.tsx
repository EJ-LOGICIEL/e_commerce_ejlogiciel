...
const sampleSalesData = [
  ...
  { month: 'Fév', amount: 5800 },
  { month: 'Mar', amount: 6500 },
  { month: 'Avr', amount: 5900 },
  { month: 'Mai', amount: 7200 },
  { month: 'Juin', amount: 9850 },
];
...
export default function Dashboard({}: DashboardProps) {
  ...
  return (
    <div className="p-4">
      <h2 className="text-2xl font-bold mb-4">Tableau de Bord d'Administration</h2>

      {isLoading ? (
        <div className="flex justify-center items-center h-64">
          <p className="text-lg">Chargement des données du tableau de bord...</p>
        </div>
      ) : (
        <>
          ...
          {/* Sales Overview */}
          <div className="mt-8">
            <h3 className="text-xl font-semibold mb-4">Aperçu des Ventes</h3>
            <div className="bg-white p-4 rounded-lg shadow">
              <div className="flex justify-between mb-4">
                <div>
                  <h4 className="text-lg font-medium">Ventes Mensuelles</h4>
                  <p className="text-gray-500">6 derniers mois</p>
                </div>
                <div>
          ...
          <div className="mt-8">
            ...
            <div className="bg-white rounded-lg shadow overflow-hidden">
              ...
              <div className="px-6 py-3 flex justify-center">
                <button className="text-blue-500 hover:text-blue-700">Voir Toutes les Commandes</button>
              </div>
            </div>
          </div>
          ...
          {/* Customers Section */}
          <div className="mt-8">
            <h3 className="text-xl font-semibold mb-4">Meilleurs Clients</h3>
            <div className="bg-white rounded-lg shadow overflow-hidden">
              <table className="min-w-full divide-y divide-gray-200">
                <thead className="bg-gray-50">
                  <tr>
              ...
              <div className="px-6 py-3 flex justify-center">
                <button className="text-blue-500 hover:text-blue-700">Voir Tous les Clients</button>
              </div>
            </div>
          </div>
        </>

      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div>
          ...
          <p className="mt-4 text-sm text-gray-600">
            Des logiciels 100% légitimes, des appareils premium, et un service humain qui t&#39;accompagne de A à Z.
          </p>
          <div className="flex justify-center space-x-4 mt-4">
            <Link href={'https://web.facebook.com/esoalahy'} className="p-2 bg-[#061e53] text-white rounded-full"><FaFacebookF /></Link>
            <Link href={'https://www.linkedin.com/company/ej-logiciel'} className="p-2 bg-[#061e53] text-white rounded-full"><FaLinkedinIn /></Link>
          </div>
        </div>
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm">
            <li><Link href="mailto:romeomanoela123@gmail.com" className="hover:text-[#061e53]">Signaler un problème</Link></li>
          </ul>
        </div>
